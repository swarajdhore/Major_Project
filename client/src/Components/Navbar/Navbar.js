...
function Navbar() {
  ...
  return (
    <nav class="bg-blue-100 max-w-full inset-x-0 h-15 py-0 sticky">
      <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-18 items-center justify-between space-y-3 space-x-3">
          <div class="flex flex-1 items-center justify-between sm:items-stretch sm:justify-start">
            <div class="flex flex-shrink-0 items-center text-decoration-none">
              <img src="/images/logo/mylogo.png" width="100px" />
            </div>
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex items-center space-x-2">
                ...
                <a class="bg-gray-900 text-white mr-2 px-2 py-2 rounded-md text-sm font-mediumm">
          ...
          <div class="absolute inset-y-0 right-0 flex items-center sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <a
              class="block mx-2 px-6 py-2 text-sm text-gray-700"
              role="menuitem"
              tabindex="-1"
              id="user-menu-item-0"
            >
              <button
                className="button flex text-center"
