                  ...
                  <div>
                    ...
                    <div class="mt-4">
                      ...
                      <p class="mt-4 text-lg text-gray-600">
                        I recently used a car trading website to sell my vehicle
                        and I couldn't be happier with the experience. The
                        website also provided helpful resources and tools to
                        make the selling process as smooth as possible. Overall,
                        I highly recommend this car trading website to anyone
                        looking to sell their vehicle.
                      </p>
                    </div>
                  </div>
                ...
                <blockquote class="flex h-full flex-col justify-between bg-white p-12">
                  <div>
                    ...
                    <div class="mt-4">
                      ...
                      <p class="mt-4 text-lg text-gray-600">
                        The website was easy to use and allowed me to quickly
                        and easily list my car for sale. Within a few days, I
                        received multiple offers from interested buyers, and was
                        able to sell my car for a fair price.
                      </p>
                    </div>
                  </div>

                  <footer class="mt-8 text-gray-500">- Rajiv Rastogi</footer>
                </blockquote>
              </div>
